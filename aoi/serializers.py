...
class AoiSerializer(GeoFeatureModelSerializer):
    class Meta:
        ...
        geo_field = 'geometry'
        fields = [
            'id', 'name', 'geometry', 'monitoring_type', 'status',
            'created_at', 'updated_at', 'start_date', 'end_date', 'is_paid'
        ]
        read_only_fields = ['id', 'created_at', 'updated_at', 'start_date', 'end_date', 'is_paid']
...
class EncroachmentDetectionSerializer(GeoFeatureModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            'id', 'aoi', 'aoi_name', 'detected_at', 'severity',
            'affected_area', 'confidence_score', 'description',
            'satellite_image_url', 'is_confirmed', 'confirmed_at'
        ]
