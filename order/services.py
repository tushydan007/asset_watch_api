        ...
        try:
            ...
            cart_item, created = CartItem.objects.get_or_create(
                ...
                defaults={
                    ...
                    'price': CartItem.PRICING.get(monitoring_type, CartItem.PRICING['daily'])
                }
            )
            ...
            if not created:
                ...
                cart_item.price = CartItem.PRICING.get(monitoring_type, CartItem.PRICING['daily'])
                cart_item.save()
...
class OrderService:
    ...
    def create_order_from_cart(user, monitoring_type, currency='USD'):
        ...
        price_per_item = CartItem.PRICING.get(monitoring_type, CartItem.PRICING['daily'])
