...
class CartItemSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = CartItem
        fields = ['id', 'aoi', 'aoi_id', 'monitoring_type', 'price', 'total_price', 'created_at']
...
class CartSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        model = Cart
        fields = ['id', 'cart_items', 'total_items', 'total_amount', 'created_at', 'updated_at']
...
class OrderCreateSerializer(serializers.Serializer):
    ...
    payment_provider = serializers.ChoiceField(choices=[('stripe', 'Stripe'), ('paystack', 'Paystack')])
